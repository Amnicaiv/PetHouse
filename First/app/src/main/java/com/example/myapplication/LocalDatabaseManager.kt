...
class LocalDatabaseManager (context:Context) :SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    override fun onCreate(p0: SQLiteDatabase?) {
        ...
        val CREATE_PET_TABLE = ("CREATE TABLE $TABLE_USER_PETS($KEY_ID INTEGER PRIMARY KEY, $KEY_PET_OWNERID INTEGER, $KEY_PET_NAME TEXT, $KEY_PET_AGE INTEGER, $KEY_PET_TYPE INTEGER, $KEY_PET_CATEGORY INTEGER, $KEY_PET_FOTO TEXT, $KEY_PET_CARNET TEXT)")
